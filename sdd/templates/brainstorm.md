...
<!-- Capabilities being introduced.
     ...
     Each accepted capability maps to a spec file at sdd/specs/<name>.spec.md -->
- `<name>`: <brief description>

### Modified Capabilities
<!-- Existing capabilities whose requirements change.
     Use existing spec names from sdd/specs/. Leave empty if none. -->
...
#### Classes & Signatures
```python
# From navigator_session/path/to/file.py:NN
...
from navigator_session.module import ClassName  # navigator_session/module/__init__.py:NN
```

#### Key Attributes & Constants
<!-- List attributes/constants that tasks will need to reference -->
- `ClassName.attribute_name` → `Type` (navigator_session/path/file.py:NN)
